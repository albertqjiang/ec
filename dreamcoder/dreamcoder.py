    ...
    for j in range(resume or 0, iterations):
        ...
        if useDSL:
            ...
            for h_program in hit_programs:
                iter_programs.append(h_program)
        ...
        with open("hit_programs.json", "w") as fhand:
            all_hit_programs.append(iter_programs)
            json.dump(all_hit_programs, fhand)
        yield result
